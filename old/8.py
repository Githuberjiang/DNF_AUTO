...
# f = pyautogui.locateOnScreen("/Users/yi/Desktop/FORFND/333.png", confidence=0.98)  # 图像匹配，返回值为True或者False
# print(f)


# im = pyautogui.screenshot()
# print(im.getpixel((100, 200)))  # 获取某点像素 (13, 41, 62, 255)
# pix = pyautogui.pixel(1342, 261)  # RGB(red=13, green=41, blue=62)
# print(pix)

# pyautogui.moveTo(950, 937)
# print(pyautogui.pixel(1000, 933),pyautogui.pixel(1000, 934),pyautogui.pixel(1000, 935), pyautogui.pixel(1000, 936))
# print(pyautogui.pixel(1000, 937),pyautogui.pixel(1000, 938),pyautogui.pixel(1000, 939), pyautogui.pixel(1000, 940))


# i = pyautogui.pixelMatchesColor(1342, 261, (60, 63, 65), tolerance=5)  # 像素匹配，返回值为True或者False
# print(i)
#
# l = ['a', 's', 'd', 'f', 'g', 'h', 'q', 'w', 'e', 'r', 't', 'y']
#
# print(random.choices(l))
# pyautogui.click(1342,261)
# pyautogui.click(1342,261)
# pyautogui.click(1342,261)
# pyautogui.press("f10")
# pyautogui.press("f10")
